...
//        }
    ...
    static void setUp() {
        try {
            server = Objects.requireNonNull(System.getProperty("server","127.0.0.1"));
            port = Integer.parseInt(System.getProperty("port","5566"));
        } catch (Exception ex) {
    ...
    static Stream<Arguments> testInteraction() {
        return Stream.of(
                ...
                arguments("Bark#05-04-2025#05:00#Ping#", REJECT),
                // Reject - Malformed time
                arguments("Mouse#2025-05-04#05#Squeak#", REJECT),
                // Final
                arguments("Cat#2025-05-04#05:00#Meow#", "Accept#6#")
        );
    }
